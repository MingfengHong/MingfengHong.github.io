...
“研究笔记”页面直接链接各平台原文，不再维护本地 Markdown 文章与动态加载服务。
...
- 更新实习经历：编辑 [`internships.html`](internships.html)。
- 更新开源项目：编辑 [`portfolio.html`](portfolio.html)。
- 更新社区作品外链：编辑 [`blog.html`](blog.html)。
